...
namespace Project.API.Controllers
{
    ...
    public class ManagementController : ControllerBase
    {
        ...
        public async Task<ActionResult<SessionTime>> CreateCourse([FromQuery] string Name, [FromQuery] int MaxStudentsNumber, [FromQuery] int startyear, [FromQuery] int startMonth, [FromQuery] int startDay, [FromQuery] int endyear, [FromQuery] int endMonth, [FromQuery] int endDay)
        {
            try
            {
